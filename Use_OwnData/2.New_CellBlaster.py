...
class CellBlaster():
    def __init__(self,ortho,symbols,output_path,query_path,query_symbol,filter_keywords): 
        self.ortho = ortho
    ...
    def draw_cell_percent(self,data,filename):
        ...
        plt.xlabel("Reference Cell Type", fontsize=18, weight='bold')
    ...
    def draw_cell_percent_clustering(self,data, filename):
        ...
        g.ax_heatmap.set_xlabel("Reference  Cell Type", fontsize=18, weight="bold", labelpad=10)
        g.ax_heatmap.set_ylabel("Query Cluster", fontsize=18, weight="bold", labelpad=10)
        plt.setp(g.ax_heatmap.get_xticklabels(), ha='right', fontsize=13)
    ...
    def draw_ctype_bar(self,df,filename):
        ...
        ax.set_xticklabels(df.index, rotation=0, ha='right', fontsize=12)
    ...
    def Annotation(self,output_path,symbols,ortho,query_path,query_symbol,filter_keywords):
        ...
        datasets = [ds[sorted(set(query_data.columns) & set(ds.columns))] for ds in datasets]
...
if __name__ == '__main__':
    ...
    cellblaster = CellBlaster(output_path,symbols,ortho,query_path,query_symbol,filter_keywords)
    result = cellblaster.Annotation(output_path,symbols,ortho,query_path,query_symbol,filter_keywords)
